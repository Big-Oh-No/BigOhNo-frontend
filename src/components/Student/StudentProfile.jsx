...
function StudentProfile(props) {
    ...
    const { department, year, degree } = user;
        ...
        <div className="flex items-center justify-center w-screen h-screen">
            <div className="bg-light-theme rounded-xl shadow-md flex flex-row space-x-10 p-8 w-3/4">
                ...
                <div>
                    ...
                    <p className="text-gray-700 mb-4"><span className="font-bold">Department:</span> {department}</p>
                    <p className="text-gray-700 mb-4"><span className="font-bold">Year:</span> {year}</p>
                    <p className="text-gray-700 mb-4"><span className="font-bold">Degree:</span> {degree}</p>
