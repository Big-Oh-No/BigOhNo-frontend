    ...
    <>
      ...
      <div className="pt-44 pl-16 text-3xl font-inter">
        ...
        <div className="pt-10 flex justify-around">
            ...
            <button onClick="" className="bg-green-700 hover:bg-green-900 hover:scale-105 transition duration-500 hover:delay-200 text-white text-xl font-inter font-semibold py-5 px-6 rounded-xl">
                Submit Assignment
            </button>
            <button onClick="" className="bg-gray-500 hover:bg-gray-700 hover:scale-105 transition duration-500 hover:delay-200 text-white text-xl font-inter font-semibold py-5 px-6 rounded-xl">
