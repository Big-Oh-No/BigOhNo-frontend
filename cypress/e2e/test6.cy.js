...
describe('Visiting the website', () => {
  ...
  it('Sign Up and Sign In', () => {
    ...
    //enter first Name
    cy.get('.mt-8 > :nth-child(1) > .px-5').type('Janee',{ delay: 100 })
    cy.wait(1000)

    //enter last Name
    cy.get('.mt-8 > :nth-child(2) > .px-5').type('Lee',{ delay: 100 ,force: true})
    cy.wait(1000)

    //enter email 
    cy.get('.mt-5.flex-col > .px-5').type('janlee@korse.com',{ delay: 100 ,force: true})
    cy.wait(1000)
    ...
    cy.get('.flex-row.mt-5 > :nth-child(2) > .px-5').type('125623',{ delay: 100 ,force: true})
    cy.wait(2000)
